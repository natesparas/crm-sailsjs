                ...
                e.exports = function() {
                    ...
                    function k(p, v) {
                        ...
                        function _(e) {
                            ...
                            void 0 !== e && "blur" !== e.type && function(e) {
                                ...
                                if (void 0 !== a.value && 2 === a.value.length) {
                                    ...
                                    f && L(void 0, -1, b.hourElement)) : d > l && (d = a === b.hourElement ? d - l - r(!b.amPM) : i,
                                    f && L(void 0, 1, b.hourElement)),
                        ...
                        function O() {
                            if (void 0 !== b.hourElement && void 0 !== b.minuteElement) {
                                ...
                                if (void 0 !== b.config.maxTime && void 0 !== b.config.minTime && b.config.minTime > b.config.maxTime) {
                                    var o = M(b.config.minTime.getHours(), b.config.minTime.getMinutes(), b.config.minTime.getSeconds())
                        ...
                        function j(e, t) {
                            ...
                            t && b.currentYear !== a && (De("onYearChange"),
                            q()),
                            !t || b.currentYear === a && b.currentMonth === i || De("onMonthChange"),
                            b.redraw()
                        }
                        function H(e) {
                            var t = g(e);
                        ...
                        function R(e, t, n, a) {
                            ...
                            }(t) && !we(t) && o.classList.add("inRange"),
                        ...
                        function J(e, t) {
                            var n = k()
                              ...
                              , i = void 0 !== e ? e : a ? n : void 0 !== b.selectedDateElem && ne(b.selectedDateElem) ? b.selectedDateElem : void 0 !== b.todayDateElem && ne(b.todayDateElem) ? b.todayDateElem : B(t > 0 ? 1 : -1);
                        ...
                        function U() {
                            if (void 0 !== b.daysContainer) {
                                ...
                                "range" === b.config.mode && 1 === b.selectedDates.length && oe()
                            }
                        }
                        function q() {
                        ...
                        function X(e) {
                            if (b.isOpen && !b.config.inline) {
                                var t = g(e)
                                  , n = Q(t)
                                  , a = !(t === b.input || t === b.altInput || b.element.contains(t) || e.path && e.path.indexOf && (~e.path.indexOf(b.input) || ~e.path.indexOf(b.altInput)) || n || Q(e.relatedTarget))
                                ...
                                void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement && "" !== b.input.value && void 0 !== b.input.value && _(),
                                b.close(),
                            ...
                            if (13 === e.keyCode && n) {
                                ...
                                case 39:
                                    if (r || n)
                                        ...
                                        e.preventDefault();
                                        var l = k();
                                        if (void 0 !== b.daysContainer && (!1 === a || l && ne(l))) {
                                ...
                                case 40:
                                    ...
                                    ee(b.currentYear - s),
                                    J(B(1), 0)) : r || J(void 0, 7 * s) : t === b.currentYearElement ? ee(b.currentYear - s) : b.config.enableTime && (!r && b.hourElement && b.hourElement.focus(),
                                    _(e),
                                    b._debouncedChange());
                                    break;
                                case 9:
                        ...
                        function oe(e, t) {
                            ...
                            1 === b.selectedDates.length && (!e || e.classList.contains(t) && !e.classList.contains("flatpickr-disabled"))) {
                                for (var n = e ? e.dateObj.getTime() : b.days.firstElementChild.dateObj.getTime(), a = b.parseDate(b.selectedDates[0], void 0, !0).getTime(), i = Math.min(n, b.selectedDates[0].getTime()), o = Math.max(n, b.selectedDates[0].getTime()), r = !1, l = 0, c = 0, s = i; s < o; s += x)
                        ...
                        function le(e) {
                            return function(t) {
                                ...
                                b.selectedDates.length || "min" !== e || F(n),
                                Me()),
                                b.daysContainer && (ue(),
                        ...
                        function ue() {
                            b.config.noCalendar || b.isMobile || (q(),
                            ye(),
                            U())
                        }
                        function fe() {
                        ...
                        function me(e) {
                            ...
                            if (void 0 !== t) {
                                ...
                                U(),
                                Me(),
                                i || "range" === b.config.mode || 1 !== b.config.showMonths ? void 0 !== b.selectedDateElem && void 0 === b.hourElement && b.selectedDateElem && b.selectedDateElem.focus() : W(n),
                        ...
                        var ge = {
                            ...
                            positionElement: [ve],
                            clickOpens: [function() {
                                !0 === b.config.clickOpens ? (P(b._input, "focus", b.open),
                                P(b._input, "click", b.open)) : (b._input.removeEventListener("focus", b.open),
                        ...
                        function De(e, t) {
                            if (void 0 !== b.config) {
                                ...
                                "onChange" === e && (b.input.dispatchEvent(be("change")),
                                b.input.dispatchEvent(be("input")))
                            }
                        }
                        function be(e) {
                        ...
                        function Me(e) {
                            ...
                            b.input.value = Ce(b.config.dateFormat),
                            void 0 !== b.altInput && (b.altInput.value = Ce(b.config.altFormat)),
                        ...
                        function xe(e) {
                            ...
                            n || a ? Z(n ? -1 : 1) : b.yearElements.indexOf(t) >= 0 ? t.select() : t.classList.contains("arrowUp") ? b.changeYear(b.currentYear + 1) : t.classList.contains("arrowDown") && b.changeYear(b.currentYear - 1)
                        }
                        return function() {
                            b.element = b.input = p,
                            b.isOpen = !1,
                            function() {
                                ...
                                u = 0; u < b.config.plugins.length; u++) {
                                    ...
                                    for (var m in f)
                                        n.indexOf(m) > -1 ? b.config[m] = c(f[m]).map(T).concat(b.config[m]) : void 0 === i[m] && (b.config[m] = f[m])
                                }
                                i.altInputClass || (b.config.altInputClass = ce().className + " " + b.config.altInputClass),
                                De("onParseConfig")
                            }(),
                            se(),
                            b.input = ce(),
                            ...
                            ve()) : b.config.errorHandler(new Error("Invalid input element specified")),
                            function() {
                                b.selectedDates = [],
                            ...
                            function() {
                                ...
                                b.isMobile)
                                    ...
                                    var e = l(re, 50);
                                    if (b._debouncedChange = l(Y, 300),
                                    b.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && P(b.daysContainer, "mouseover", (function(e) {
                                    ...
                                    !0 === b.config.clickOpens && (P(b._input, "focus", b.open),
                                    P(b._input, "click", b.open)),
                                    void 0 !== b.daysContainer && (P(b.monthNav, "click", xe),
                                    P(b.monthNav, ["keyup", "increment"], N),
                                    P(b.daysContainer, "click", me)),
                                    void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement) {
                                        var t = function(e) {
                                            return g(e).select()
                                        };
                                        P(b.timeContainer, ["increment"], _),
                                        P(b.timeContainer, "blur", _, {
                                            capture: !0
                                        }),
                                        P(b.timeContainer, "click", H),
                                        P([b.hourElement, b.minuteElement], ["focus", "click"], t),
                            ...
                            (b.selectedDates.length || b.config.noCalendar) && (b.config.enableTime && F(b.config.noCalendar ? b.latestSelectedDateObj : void 0),
                            Me(!1)),
                            I();
