...
$(function () {
    ...
    i.length && (i = i).wrap('<div class="position-relative"></div>').select2({ placeholder: "Select Country", dropdownParent: i.parent() }),
        n.length &&
            (e = n.DataTable({
                ajax: "http://localhost/hbl/assets/js/user-list.json",
                columns: [{ data: "" }, { data: "full_name" }, { data: "role" }, { data: "current_plan" }, { data: "billing" }, { data: "date" }, { data: "status" }, { data: "action" }],
                columnDefs: [
                    {
                        className: "control",
                        searchable: !1,
                            ...
                            return (
                                ...
                                (o
                                    ...
                                    : '<span class="avatar-initial rounded-circle bg-label-' +
                                      ...
                                      '">' +
                                      (o = (((o = (n = a.full_name).match(/\b\w/g) || []).shift() || "") + (o.pop() || "")).toUpperCase()) +
                                      "</span>") +
                ...
                initComplete: function () {
                    this.api()
                        ...
                        .every(function () {
                            var t = this,
                                a = $('<select id="UserRole" class="form-select text-capitalize"><option value=""> Select Branch </option></select>')
                        ...
                        this.api()
                        	...
                        	.every(function () {
                        		var t = this
                        			a = $('<input type="text" class="form-control flatpickr-input" placeholder="YYYY-MM-DD to YYYY-MM-DD" id="flatpickr-range" readonly="readonly">')
                        				.appendTo(".user_date")
                                        // .on("change", function () {
                                        //     var e = $.fn.dataTable.util.escapeRegex($(this).val());
                                        //     t.search(e ? "^" + e + "$" : "", !0, !1).draw();
